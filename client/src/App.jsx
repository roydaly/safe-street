...
class App extends React.Component {
  ...
  handleRootLink() {
    ...
    .then((data) => {
      ...
      data.forEach(crime => {
        //if within 10 years
        if (crimeData.details[crime.crime_subcategory]) {
          crimeData.details[crime.crime_subcategory]++;
        } else {
          crimeData.details[crime.crime_subcategory] = 1;
        }
        crimeData.total++;
      })
      
      this.setState({ apiData: crimeData })
    })
